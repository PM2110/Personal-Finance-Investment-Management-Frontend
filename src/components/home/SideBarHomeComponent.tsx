...
const SideBarHomeComponent: React.FC<SideBarSendMoneyComponentProps> = ({ selected, setSelected }) => {
    ...
    return (
        <div className={`flex flex-col gap-8 bg-[#F6F8FA] font-bold h-screen ${open ? "min-w-[180px] sm:min-w-[200px] sm:w-[200px] md:w-[210px] md:min-w-[210px]" : "w-[72px]"} transition-all duration-300 text-[12px] px-4 py-8 lg:text-[14px] text-[#818898]`}>
