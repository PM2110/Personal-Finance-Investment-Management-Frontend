...
const MainFamilyComponent = () => {
    ...
    const filteredFamilies = families.filter((family: FamilyData) =>
        ...
        <div className="flex w-full h-full flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6">
            ...
            <div className="flex flex-col gap-3">
                {filteredFamilies && filteredFamilies.length !== 0
                    ? filteredFamilies.map((family: FamilyData, index: number) => (
                    ...
                    : <div className="flex items-center justify-center h-full w-full text-[#666D80]">No families found.</div>}
            </div>
