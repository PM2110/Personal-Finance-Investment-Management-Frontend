...
const DashboardTransactionCardComponent = () => {
    ...
    return (
        <div className="flex flex-col gap-3 p-3 border-[#DFE1E7] border-2 rounded-xl">
            ...
            <div className="w-full justify-evenly ml-auto flex gap-2 bg-[#ECEFF3] p-1 rounded-lg text-[#666D80] text-[14px] ">
            ...
            <div className="bg-[#DFE1E7] h-[1px]"></div>
            <button className="flex gap-3 w-full items-center justify-center border-[#DFE1E7] border-2 p-3 rounded-xl ">See All <RiArrowRightUpLine /></button>
        </div>
    );
}
