    ...
    return (
        <div className="bg-[#F6F8FA] font-bold h-screen w-[300px] text-[12px] px-4 py-8 md:w-[350px] md:[text-13px] lg:text-[14px] text-[#818898]">
            ...
            <div className="flex flex-col mt-4 gap-2">
                ...
                <button onClick={() => setSelected(2)} className={`flex gap-3 items-center ${selected === 2 ? "border-black border-[2px] rounded-full bg-white text-black" : "border-[#F6F8FA] border-[2px]" } px-2 py-[6px]`}>
                    <div className="border-[#DFE1E7] bg-white border-2 rounded-full px-[7px] py-[1px]">
                        2
                    </div>
                    Personal Details
                </button>
                <button onClick={() => setSelected(3)} className={`flex gap-3 items-center ${selected === 3 ? "border-black border-[2px] rounded-full bg-white text-black" : "border-[#F6F8FA] border-[2px]" } px-2 py-[6px]`}>
                    <div className="border-[#DFE1E7] bg-white border-2 rounded-full px-[7px] py-[1px]">
                        3
                    </div>
                    Recipient
