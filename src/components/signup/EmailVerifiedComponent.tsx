    ...
    return (
        <div className="flex flex-col gap-5 justify-center items-center h-auto bg-white w-[425px] border-[#DFE1E7] rounded-2xl px-8 py-6 border-2">
            ...
            <div className="flex flex-col items-center gap-[15px]">
                ...
                <button className="mt-2 bg-black text-white text-[15px] w-full py-[6px] font-bold border-black border-2 hover:bg-white hover:text-black rounded-lg">Continue</button>
            </div>
        </div>
    );
};
